...
<head>
  ...
  <title>Парсинг Яндекс.Погоды</title>
    ...
    <div class="weather__container container">
      ...
      <div class="weather-table__wrapper">
        <table class="weather-table">
          ...
          <tbody>
            <? $data = json_decode(file_get_contents('assets/data/weather.json'), JSON_OBJECT_AS_ARRAY);
            for ($i = 0; $i < count($data); $i++) { ?>
              <tr>
                ...
                <td><?= $data[$i]['temp_day'] ?></td>
                <td><?= $data[$i]['temp_night'] ?></td>
              </tr>
            <? } ?>
          </tbody>
        </table>
